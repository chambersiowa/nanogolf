...
Nanogolf.Digitala = function(){};

Nanogolf.Digitala.prototype = {
preload: function() {
    this.screen = 0;
    this.goal = 2;
    this.sgoal = 2;
...
create: function() {
    ...
    this.specialSpawn();
	 ...
	 this.pad = this.add.sprite(380, 572, 'pad');
	this.pad.anchor.setTo(.5);
    this.pad.alpha = 0;
	 this.hole = this.add.sprite(380, 572, 'hole');
    ...
    this.ball.spawnx = 400;
    this.ball.spawny = 325;
    this.ball.snapx = 0;
    this.ball.snapy = 0;
    this.ball.idle = 0;
...
bumpUpdate: function(){
    switch(this.screen){
        case 0: {
            //this.objectgroup.children[1].body.rotateRight(14);
            break;
        }
        case 1: {break;}
        case 2: {break;}
...
fireShot: function(){
	...
	if(this.aimactive){
        ...
        if(this.slowmode){
			if(this.screen == 0){
				this.objectgroup.children[0].body.rotateRight(80);
			}
			this.slowmode = false;
		}
        this.slowcounter = 0;
...
despawnUpdate: function(){
    ...
    if(this.darkoverlay.alpha > .97){
        ...
        switch(this.screen){ //jumphere
            case 0: {this.ball.spawnx = 400; this.ball.spawny = 325; this.goal = 2; this.sgoal = 2;
                     this.hole.x = 380; this.hole.y = 572; this.pad.x = 380; this.pad.y = 572; break;}
            case 1: {this.ball.spawnx = 620; this.ball.spawny = 250; this.goal = 3; this.sgoal = 3;
                     this.hole.x = 800; this.hole.y = 600; this.pad.x = 800; this.pad.y = 600; break;}
            case 2: {this.ball.spawnx = 300; this.ball.spawny = 450; this.goal = 3; this.sgoal = 3;
                     this.hole.x = 450; this.hole.y = 300; this.pad.x = 450; this.pad.y = 300; break;}
            case 3: {this.ball.spawnx = 290; this.ball.spawny = 325; this.goal = 4; this.sgoal = 4;
                     this.hole.x = 300; this.hole.y = 550; this.pad.x = 300; this.pad.y = 550; break;}
            case 4: {this.ball.spawnx = 500; this.ball.spawny = 400; this.goal = 3; this.sgoal = 3;
                     this.hole.x = 700; this.hole.y = 600; this.pad.x = 700; this.pad.y = 600; break;}
            case 5: {this.ball.spawnx = 400; this.ball.spawny = 300; this.goal = 4; this.sgoal = 4;
                     this.hole.x = 380; this.hole.y = 600; this.pad.x = 380; this.pad.y = 600; break;}
            case 6: {this.ball.spawnx = 940; this.ball.spawny = 580; this.goal = 4; this.sgoal = 4; 
                     this.hole.x = 795; this.hole.y = 530; this.pad.x = 795; this.pad.y = 530; break;}
            case 7: {this.ball.spawnx = 450; this.ball.spawny = 450; this.goal = 4; this.sgoal = 4;
                     this.hole.x = 850; this.hole.y = 450; this.pad.x = 850; this.pad.y = 450; break;}
            case 8: {this.ball.spawnx = 550; this.ball.spawny = 525; this.goal = 5; this.sgoal = 5;
                     this.hole.x = 350; this.hole.y = 450; this.pad.x = 350; this.pad.y = 450; break;}
        }
...
specialSpawn: function(){
    switch(this.screen){
        case 0: {break;}
        case 1: {
            this.spawnRedGrid(650, 450);
            this.spawnRedGrid(240, 450);
            this.spawnRedGrid(1060, 450);
            break;}
        case 2: {
             spec = this.specialgroup.create(565, 500, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0x00FF00;
            spec.timer = 0;
            spec.design = 2;
            spec.alpha = 0;
             spec = this.specialgroup.create(735, 500, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0x00FF00;
            spec.timer = 0;
            spec.design = 3;
            ...
            break;}
        case 3: {
			this.spawnRedGrid(480, 325);
			this.spawnRedGrid(640, 325);
			this.spawnRedGrid(800, 325);
			this.spawnRedGrid(900, 680);
			this.spawnRedGrid(780, 480);
			this.spawnRedGrid(660, 680);
			this.spawnRedGrid(540, 480);
			this.spawnRedGrid(420, 680);
			break;}
        case 4: {
             spec = this.specialgroup.create(600, 400, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0x00FF00;
            spec.timer = 0;
            spec.design = 2;
            spec.alpha = 0;
             spec = this.specialgroup.create(700, 500, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0x00FF00;
            spec.timer = 0;
            spec.design = 3;
            spec.alpha = 0;
             spec = this.specialgroup.create(700, 400, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0xFF00FF;
            spec.timer = 0;
            spec.design = 2;
            spec.alpha = 0;
             spec = this.specialgroup.create(600, 500, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0xFF00FF;
            spec.timer = 0;
            spec.design = 3;
            ...
            break;}
        case 5: {
            this.spawnRedGrid(650, 400);
            this.spawnRedGrid(690, 400);
            this.spawnRedGrid(730, 400);
            this.spawnRedGrid(610, 400);
            this.spawnRedGrid(650, 490);
            this.spawnRedGrid(690, 490);
            this.spawnRedGrid(730, 490);
            this.spawnRedGrid(610, 490);

            this.spawnRedGrid(835, 420);
            this.spawnRedGrid(835, 380);
            this.spawnRedGrid(835, 340);
            this.spawnRedGrid(690, 360);
            this.spawnRedGrid(690, 320);
            this.spawnRedGrid(690, 280);
            this.spawnRedGrid(690, 240);
			
             spec = this.specialgroup.create(300, 300, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0x00FF00;
            spec.timer = 0;
            spec.design = 2;
            spec.alpha = 0;
             spec = this.specialgroup.create(911, 290, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0x00FF00;
            spec.timer = 0;
            spec.design = 3;
            spec.alpha = 0;
             spec = this.specialgroup.create(560, 445, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0xFF00FF;
            spec.timer = 0;
            spec.design = 2;
            spec.alpha = 0;
             spec = this.specialgroup.create(865, 290, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0xFF00FF;
            spec.timer = 0;
            spec.design = 3;
            spec.alpha = 0;
             spec = this.specialgroup.create(911, 370, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0x00FFFF;
            spec.timer = 0;
            spec.design = 2;
            spec.alpha = 0;
             spec = this.specialgroup.create(480, 400, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0x00FFFF;
            spec.timer = 0;
            spec.design = 3;
            spec.alpha = 0;
             spec = this.specialgroup.create(380, 400, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0xFFFF00;
            spec.timer = 0;
            spec.design = 2;
            spec.alpha = 0;
             spec = this.specialgroup.create(775, 445, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0xFFFF00;
            spec.timer = 0;
            spec.design = 3;
            ...
            break;}
        case 6: {
			this.spawnRedGrid(900, 630);
			this.spawnRedGrid(860, 630);
			this.spawnRedGrid(820, 630);
			this.spawnRedGrid(780, 630);
			this.spawnRedGrid(740, 630);
			this.spawnRedGrid(700, 630);
			this.spawnRedGrid(660, 630);
			this.spawnRedGrid(620, 630);
			this.spawnRedGrid(580, 630);
			this.spawnRedGrid(540, 630);
			this.spawnRedGrid(500, 630);
            this.spawnRedGrid(460, 630);
			this.spawnRedGrid(420, 630);
            this.spawnRedGrid(380, 630);
			
			this.spawnRedGrid(900, 530);
			this.spawnRedGrid(860, 530);
            this.spawnRedGrid(740, 530);
			this.spawnRedGrid(700, 530);
			this.spawnRedGrid(660, 530);
			this.spawnRedGrid(620, 530);
			this.spawnRedGrid(580, 530);
			this.spawnRedGrid(540, 530);
			this.spawnRedGrid(500, 530);
           
			this.spawnRedGrid(900, 490);
			this.spawnRedGrid(860, 490);
			this.spawnRedGrid(740, 490);
			this.spawnRedGrid(700, 490);
			this.spawnRedGrid(660, 490);
			this.spawnRedGrid(620, 490);
			this.spawnRedGrid(580, 490);
			this.spawnRedGrid(540, 490);
			this.spawnRedGrid(500, 490);
            
			this.spawnRedGrid(380, 590);
			this.spawnRedGrid(380, 550);
			this.spawnRedGrid(380, 510);
			this.spawnRedGrid(380, 470);
			this.spawnRedGrid(380, 430);
			this.spawnRedGrid(380, 390);
            
			this.spawnRedGrid(420, 390);
			this.spawnRedGrid(460, 390);
			this.spawnRedGrid(500, 390);
			this.spawnRedGrid(540, 390);
			this.spawnRedGrid(580, 390);
			this.spawnRedGrid(620, 390);
			this.spawnRedGrid(660, 390);
			this.spawnRedGrid(700, 390);
			this.spawnRedGrid(740, 390);
			this.spawnRedGrid(780, 390);
			this.spawnRedGrid(820, 390);
            
             spec = this.specialgroup.create(795, 440, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0x00FF00;
            spec.timer = 0;
            spec.design = 2;
            spec.alpha = 0;
             spec = this.specialgroup.create(625, 345, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0x00FF00;
            spec.timer = 0;
            spec.design = 3;
            ...
            break;}
        case 7: {
            this.spawnRedGrid(650, 190);
            this.spawnRedGrid(650, 230);
            this.spawnRedGrid(650, 350);
            this.spawnRedGrid(650, 390);
            this.spawnRedGrid(650, 510);
            this.spawnRedGrid(650, 550);
            this.spawnRedGrid(650, 670);
            this.spawnRedGrid(650, 710);
            
             spec = this.specialgroup.create(440, 360, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0x00FF00;
            spec.timer = 0;
            spec.design = 2;
            spec.alpha = 0;
             spec = this.specialgroup.create(800, 490, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0x00FF00;
            spec.timer = 0;
            spec.design = 3;
            spec.alpha = 0;
             spec = this.specialgroup.create(550, 300, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0xFF00FF;
            spec.timer = 0;
            spec.design = 2;
            spec.alpha = 0;
             spec = this.specialgroup.create(920, 545, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0xFF00FF;
            spec.timer = 0;
            spec.design = 3;
            spec.alpha = 0;
             spec = this.specialgroup.create(510, 610, 'porta'); 
            spec.anchor.setTo(.5);
            spec.tint = 0x0000FF;
            spec.timer = 0;
            spec.design = 2;
            spec.alpha = 0;
             spec = this.specialgroup.create(730, 350, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0x0000FF;
            spec.timer = 0;
            spec.design = 3;
            ...
            break;}
        case 8: {
             spec = this.specialgroup.create(350, 300, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0x00FF00;
            spec.timer = 0;
            spec.design = 2;
            spec.alpha = 0;
             spec = this.specialgroup.create(650, 450, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0x00FF00;
            spec.timer = 0;
            spec.design = 3;
            spec.alpha = 0;
             spec = this.specialgroup.create(500, 600, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0xFF0000;
            spec.timer = 0;
            spec.design = 2;
            spec.alpha = 0;
             spec = this.specialgroup.create(650, 300, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0xFF0000;
            spec.timer = 0;
            spec.design = 3;
            spec.alpha = 0;
             spec = this.specialgroup.create(800, 600, 'porta'); 
            spec.anchor.setTo(.5);
            spec.tint = 0x0000FF;
            spec.timer = 0;
            spec.design = 2;
            spec.alpha = 0;
             spec = this.specialgroup.create(500, 450, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0x0000FF;
            spec.timer = 0;
            spec.design = 3;
            spec.alpha = 0;
             spec = this.specialgroup.create(350, 600, 'porta'); 
            spec.anchor.setTo(.5);
            spec.tint = 0xFF00FF;
            spec.timer = 0;
            spec.design = 2;
            spec.alpha = 0;
             spec = this.specialgroup.create(800, 450, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0xFF00FF;
            spec.timer = 0;
            spec.design = 3;
            spec.alpha = 0;
             spec = this.specialgroup.create(500, 300, 'porta'); 
            spec.anchor.setTo(.5);
            spec.tint = 0xFFFF00;
            spec.timer = 0;
            spec.design = 2;
            spec.alpha = 0;
             spec = this.specialgroup.create(800, 300, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0xFFFF00;
            spec.timer = 0;
            spec.design = 3;
            spec.alpha = 0;
             spec = this.specialgroup.create(650, 600, 'porta'); 
            spec.anchor.setTo(.5);
            spec.tint = 0x00FFFF;
            spec.timer = 0;
            spec.design = 2;
            spec.alpha = 0;
             spec = this.specialgroup.create(950, 300, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0x00FFFF;
            spec.timer = 0;
            spec.design = 3;
            spec.alpha = 0;
             spec = this.specialgroup.create(950, 600, 'porta'); 
            spec.anchor.setTo(.5);
            spec.tint = 0xFFFFFF;
            spec.timer = 0;
            spec.design = 2;
            spec.alpha = 0;
             spec = this.specialgroup.create(950, 450, 'porta');
            spec.anchor.setTo(.5);
            spec.tint = 0xFFFFFF;
            spec.timer = 0;
            spec.design = 3;
...
electronSpawn: function(){
    switch(this.screen){
        case 0: {
            glow= this.electrongroup.create(835, 450, 'electron');
            glow= this.electrongroup.create(323, 679, 'electron');
            break;
        }
        case 1: {
            glow= this.electrongroup.create(350, 420, 'electron');
            glow= this.electrongroup.create(950, 420, 'electron');
            glow= this.electrongroup.create(650, 515, 'electron');
            break;
        }
        case 2: {
            glow= this.electrongroup.create(545, 660, 'electron');
            glow= this.electrongroup.create(650, 300, 'electron');
            glow= this.electrongroup.create(740, 350, 'electron');
            break;
        }
        case 3: {
            glow= this.electrongroup.create(560, 325, 'electron');
            glow= this.electrongroup.create(720, 325, 'electron');
            glow= this.electrongroup.create(1000, 450, 'electron');
            glow= this.electrongroup.create(535, 675, 'electron');
            break;
        }
        case 4: {
            glow= this.electrongroup.create(1050, 450, 'electron');
            glow= this.electrongroup.create(250, 450, 'electron');
            glow= this.electrongroup.create(750, 450, 'electron');
            break;
        }
        case 5: {
            glow= this.electrongroup.create(430, 400, 'electron');
            glow= this.electrongroup.create(670, 445, 'electron');
            glow= this.electrongroup.create(975, 375, 'electron');
            glow= this.electrongroup.create(380, 500, 'electron');
            break;
        }
        case 6: {
            glow= this.electrongroup.create(490, 575, 'electron');
            glow= this.electrongroup.create(490, 435, 'electron');
            glow= this.electrongroup.create(795, 480, 'electron');
            glow= this.electrongroup.create(670, 250, 'electron');
            break;
        }
        case 7: {
            glow= this.electrongroup.create(735, 230, 'electron');
            glow= this.electrongroup.create(550, 360, 'electron');
            glow= this.electrongroup.create(680, 450, 'electron');
            glow= this.electrongroup.create(620, 450, 'electron');
            break;
        }
        case 8: {
            glow= this.electrongroup.create(875, 525, 'electron');
            glow= this.electrongroup.create(1075, 450, 'electron');
            glow= this.electrongroup.create(275, 245, 'electron');
            glow= this.electrongroup.create(575, 375, 'electron');
            glow= this.electrongroup.create(725, 375, 'electron');
            break;
        }
    }
...
objectSpawn: function(){
    switch(this.screen){
        case 0: {   
            ...
            bump.alpha = 0;
			bump.body.rotateRight(80);
			
			 bump = this.objectgroup.create(850, 450, 'bumprect1');
            bump.tint = 0x66FF66;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
			bump.body.angle = 90;
        ...
        case 1: {
             bump = this.objectgroup.create(600, 400, 'bumpcolumn');
            bump.tint = 0x66FF66;
            this.game.physics.p2.enable(bump);
        ...
        case 2: {
             bump = this.objectgroup.create(650, 514, 'bumprect1');
            bump.tint = 0x66FF66;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.alpha = 0;
        ...
        case 3: {
			 bump = this.objectgroup.create(317, 450, 'bumprect1');
            bump.tint = 0x66FF66;
            this.game.physics.p2.enable(bump);
            bump.body.setRectangle(1, 1, 0, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(489, 450, 'bumprect1');
            bump.tint = 0x66FF66;
            this.game.physics.p2.enable(bump);
            bump.body.setRectangle(688, 25, 86, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;

             bump = this.objectgroup.create(661, 450, 'bumprect1');
            bump.tint = 0x66FF66;
            this.game.physics.p2.enable(bump);
            bump.body.setRectangle(1, 1, 0, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(833, 450, 'bumprect1');
            bump.tint = 0x66FF66;
            this.game.physics.p2.enable(bump);
            bump.body.setRectangle(1, 1, 0, 0, 0);
            bump.body.static = true;
        ...
        case 5: {
             bump = this.objectgroup.create(650, -100, 'bumpsquare2');
            bump.tint = 0x66FF66;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.alpha = 0;
        ...
        case 6: {
             bump = this.objectgroup.create(720, 360, 'bumptri2');
            bump.tint = 0x66FF66;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            ...
            bump.body.angle = -90;
            bump.alpha = 0;
             bump = this.objectgroup.create(720, 260, 'bumptri2');
            bump.tint = 0x66FF66;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "triangle2");
            ...
            bump.body.angle = -180;
            bump.alpha = 0;
             bump = this.objectgroup.create(620, 260, 'bumptri2');
            bump.tint = 0x66FF66;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "triangle2");
        ...
        case 7: {
             bump = this.objectgroup.create(650, 270, 'bumpsquare2');
            bump.tint = 0x66FF66;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.setRectangle(40, 80, 0, 20);
            bump.body.static = true;
            bump.alpha = 0;
             bump = this.objectgroup.create(650, 310, 'bumpsquare2');
            bump.tint = 0x66FF66;
            this.game.physics.p2.enable(bump);
            bump.body.setRectangle(1, 1, 0, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
             bump = this.objectgroup.create(650, 430, 'bumpsquare2');
            bump.tint = 0x66FF66;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.setRectangle(40, 80, 0, 20);
            bump.body.static = true;
            bump.alpha = 0;
             bump = this.objectgroup.create(650, 470, 'bumpsquare2');
            bump.tint = 0x66FF66;
            this.game.physics.p2.enable(bump);
            bump.body.setRectangle(1, 1, 0, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
             bump = this.objectgroup.create(650, 590, 'bumpsquare2');
            bump.tint = 0x66FF66;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.setRectangle(40, 80, 0, 20);
            bump.body.static = true;
            bump.alpha = 0;
             bump = this.objectgroup.create(650, 630, 'bumpsquare2');
            bump.tint = 0x66FF66;
            this.game.physics.p2.enable(bump);
            bump.body.setRectangle(1, 1, 0, 0, 0);
            bump.body.static = true;
