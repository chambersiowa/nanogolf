...
Nanogolf.Noisea = function(){};

Nanogolf.Noisea.prototype = {
preload: function() {
    this.screen = 0;
    this.goal = 3;
	this.sgoal = 3;
...
bumpUpdate: function(){
    ...
    switch(this.screen){
        ...
        case 2: {
			if(this.coursetimer){
				this.objectgroup.children[2].body.y += 3;
				if(this.objectgroup.children[2].body.y > 650){this.coursetimer = 0;}
			}
			else{
				this.objectgroup.children[2].body.y -= 3;
				if(this.objectgroup.children[2].body.y < 250){this.coursetimer = 1;}
			}
            break;}
        case 3: {break;}
        case 4: {
			if(this.coursetimer){
				this.objectgroup.children[0].body.y += 1;
				this.objectgroup.children[1].body.y -= 1;
				this.objectgroup.children[2].body.x += 1.5;
				this.objectgroup.children[3].body.y += 3;
				this.objectgroup.children[4].body.x -= 1.2;
				if(this.objectgroup.children[0].body.y > 340){this.coursetimer = 0;}
			}
			else{
				this.objectgroup.children[0].body.y -= 1;
				this.objectgroup.children[1].body.y += 1;
				...
				this.objectgroup.children[3].body.y -= 3;
				this.objectgroup.children[4].body.x += 1.2;
				if(this.objectgroup.children[0].body.y < 200){this.coursetimer = 1;}
			}
			break;}
        case 5: {break;}
        case 6: {break;}
        case 7: {
			if(this.coursetimer){
				this.objectgroup.children[16].body.y -= 1;
				if(this.objectgroup.children[16].body.y < 513){this.coursetimer = 0;}
			}
			else{
				this.objectgroup.children[16].body.y += 1;
				if(this.objectgroup.children[16].body.y > 610){this.coursetimer = 1;}
			}
			break;}
        case 8: {
			if(this.coursetimer){
				this.specialgroup.children[0].x += 2.5;
				this.specialgroup.children[1].x += 2.5;
				this.specialgroup.children[2].x += 2.5;
				if(this.specialgroup.children[0].x > 1000){this.coursetimer = 0;}
			}
			else{
				this.specialgroup.children[0].x -= 2.5;
				this.specialgroup.children[1].x -= 2.5;
				this.specialgroup.children[2].x -= 2.5;
				if(this.specialgroup.children[0].x < 300){this.coursetimer = 1;}
			}
			break;}
    }
},
...
despawnUpdate: function(){
    ...
    if(this.hole.scale.x < .03){
        ...
        switch(this.screen){
            case 0: {this.ball.spawnx = 475; this.ball.spawny = 300; this.goal = 3; this.sgoal = 3;
                     this.hole.x = 800; this.hole.y = 500; this.pad.x = 800; this.pad.y = 500; break;}
            case 1: {this.ball.spawnx = 400; this.ball.spawny = 600; this.goal = 4; this.sgoal = 4;
                     this.hole.x = 268; this.hole.y = 302; this.pad.x = 268; this.pad.y = 302; break;}
            case 2: {this.ball.spawnx = 280; this.ball.spawny = 575; this.goal = 3; this.sgoal = 3;
                     this.hole.x = 230; this.hole.y = 230; this.pad.x = 230; this.pad.y = 230; break;}
            case 3: {this.ball.spawnx = 500; this.ball.spawny = 500; this.goal = 8; this.sgoal = 8;
                     this.hole.x = 600; this.hole.y = 300; this.pad.x = 600; this.pad.y = 300; break;}
            case 4: {this.ball.spawnx = 250; this.ball.spawny = 450; this.goal = 7; this.sgoal = 7;
                     this.hole.x = 250; this.hole.y = 300; this.pad.x = 250; this.pad.y = 300; break;}
            case 5: {this.ball.spawnx = 750; this.ball.spawny = 575; this.goal = 5; this.sgoal = 5;
                     this.hole.x = 650; this.hole.y = 600; this.pad.x = 650; this.pad.y = 600; break;}
            case 6: {this.ball.spawnx = 700; this.ball.spawny = 640; this.goal = 8; this.sgoal = 8;
                     this.hole.x = 550; this.hole.y = 245; this.pad.x = 550; this.pad.y = 245; break;}
            case 7: {this.ball.spawnx = 310; this.ball.spawny = 220; this.goal = 5; this.sgoal = 5;
                     this.hole.x = 832; this.hole.y = 652; this.pad.x = 832; this.pad.y = 652; break;}
            case 8: {this.ball.spawnx = 230; this.ball.spawny = 450; this.goal = 6; this.sgoal = 6;
                     this.hole.x = 785; this.hole.y = 660; this.pad.x = 785; this.pad.y = 660; break;}
        }
    }
},
...
specialSpawn: function(){
    switch(this.screen){
        case 0: {break;}
        case 1: {
             spec = this.specialgroup.create(650, 620, 'noisehill2');
            spec.anchor.setTo(.5);
            spec.alpha = .4;
            spec.scale.x = 40;
            spec.design = 1;
             spec = this.specialgroup.create(650, 580, 'noisehill3');
            spec.anchor.setTo(.5,1);
            spec.alpha = .4;
            spec.scale.setTo(40);
            spec.design = 2;
             spec = this.specialgroup.create(650, 660, 'noisehill3');
            spec.anchor.setTo(.5,1);
            spec.alpha = .4;
            spec.scale.setTo(40,-40);
            spec.design = 3;
			
			 spec = this.specialgroup.create(650, 280, 'noisehill2');
            spec.anchor.setTo(.5);
            spec.alpha = .4;
            spec.scale.x = 40;
            spec.design = 1;
             spec = this.specialgroup.create(650, 240, 'noisehill3');
            spec.anchor.setTo(.5,1);
            spec.alpha = .4;
            spec.scale.setTo(40);
            spec.design = 2;
             spec = this.specialgroup.create(650, 320, 'noisehill3');
            spec.anchor.setTo(.5,1);
            spec.alpha = .4;
            spec.scale.setTo(40,-40);
            spec.design = 3;
            break;}
        case 2: {
			 spec = this.specialgroup.create(890, 270, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
             spec = this.specialgroup.create(800, 270, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(890, 360, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
             spec = this.specialgroup.create(800, 360, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(890, 450, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
             spec = this.specialgroup.create(800, 450, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(800, 540, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(890, 540, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(800, 630, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(890, 630, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
            ...
            break;}
        case 3: {
			 spec = this.specialgroup.create(400, 400, 'noisehill');
            spec.anchor.setTo(.5);
            spec.alpha = .2;
            spec.scale.setTo(18);
            spec.design = 4;
			 spec = this.specialgroup.create(500, 300, 'noisehill');
            spec.anchor.setTo(.5);
            spec.alpha = .2;
            spec.scale.setTo(18);
            spec.design = 4;
			 spec = this.specialgroup.create(600, 400, 'noisehill');
            spec.anchor.setTo(.5);
            spec.alpha = .2;
            spec.scale.setTo(18);
            spec.design = 4;
			 spec = this.specialgroup.create(400, 600, 'noisehill');
            spec.anchor.setTo(.5);
            spec.alpha = .2;
            spec.scale.setTo(18);
            spec.design = 4;
			 spec = this.specialgroup.create(500, 500, 'noisehill');
            spec.anchor.setTo(.5);
            spec.alpha = .2;
            spec.scale.setTo(18);
            spec.design = 4;
			 spec = this.specialgroup.create(600, 600, 'noisehill');
            spec.anchor.setTo(.5);
            spec.alpha = .2;
            spec.scale.setTo(18);
            spec.design = 4;
			
			 spec = this.specialgroup.create(700, 300, 'noisehill');
            spec.anchor.setTo(.5);
            spec.alpha = .2;
            spec.scale.setTo(18);
            spec.design = 4;
			 spec = this.specialgroup.create(800, 400, 'noisehill');
            spec.anchor.setTo(.5);
            spec.alpha = .2;
            spec.scale.setTo(18);
            spec.design = 4;
			 spec = this.specialgroup.create(900, 300, 'noisehill');
            spec.anchor.setTo(.5);
            spec.alpha = .2;
            spec.scale.setTo(18);
            spec.design = 4;
			 spec = this.specialgroup.create(700, 500, 'noisehill');
            spec.anchor.setTo(.5);
            spec.alpha = .2;
            spec.scale.setTo(18);
            spec.design = 4;
			 spec = this.specialgroup.create(800, 600, 'noisehill');
            spec.anchor.setTo(.5);
            spec.alpha = .2;
            spec.scale.setTo(18);
            spec.design = 4;
			 spec = this.specialgroup.create(900, 500, 'noisehill');
            spec.anchor.setTo(.5);
            spec.alpha = .2;
            spec.scale.setTo(18);
            spec.design = 4;
			break;}
        case 4: {
			 spec = this.specialgroup.create(375, 275, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(375, 365, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(465, 275, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(555, 275, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(485, 470, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(575, 470, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(530, 560, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(375, 625, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 ...
			 spec = this.specialgroup.create(660, 625, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(750, 592, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(750, 460, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(750, 328, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 ...
			 spec = this.specialgroup.create(925, 275, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(925, 365, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(925, 455, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(925, 545, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000; 
			 ...
			 spec = this.specialgroup.create(637, 370, 'noisehill');
            spec.anchor.setTo(.5);
            spec.alpha = .2;
            spec.scale.setTo(18);
            spec.design = 4;
        ...
        case 5: {
            ...
            spec.alpha = .2;
            spec.scale.setTo(150, 100);
			spec.design = 6;
			spec.orient = 0;
			
			 spec = this.specialgroup.create(1100, 450, 'noisehill4');
            spec.anchor.setTo(0,.5);
            spec.alpha = .2;
			spec.angle = 180;
            spec.scale.setTo(150, 100);
			...
			break;}
        case 6: {
			 spec = this.specialgroup.create(350, 450, 'noisehill4');
            spec.anchor.setTo(0,.5);
            spec.alpha = .2;
            spec.scale.setTo(150, 60);
			spec.design = 6;
			spec.orient = 0;
			
			 spec = this.specialgroup.create(950, 450, 'noisehill4');
            spec.anchor.setTo(0,.5);
            spec.alpha = .2;
			spec.angle = 180;
            spec.scale.setTo(150, 60);
			...
			spec.orient = 1;
			 ...
			 spec = this.specialgroup.create(650, 620, 'noisehill');
            spec.anchor.setTo(.5);
            spec.alpha = .2;
            spec.scale.setTo(18);
            spec.design = 4;
			 spec = this.specialgroup.create(650, 280, 'noisehill');
            spec.anchor.setTo(.5);
            spec.alpha = .2;
            spec.scale.setTo(18);
            spec.design = 4;
			break;}
        case 7: {
			 spec = this.specialgroup.create(560, 242, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(760, 242, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 ...
			 spec = this.specialgroup.create(630, 359, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(546, 359, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(462, 359, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(378, 359, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(378, 445, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 ...
			 spec = this.specialgroup.create(250, 654, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(485, 654, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(570, 654, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(655, 654, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(740, 654, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			...
			break;}
        case 8: {
			 spec = this.specialgroup.create(300, 450, 'noisehill2');
            spec.anchor.setTo(.5);
            spec.alpha = .4;
            spec.scale.setTo(40,1.6);
            spec.design = 1;
             spec = this.specialgroup.create(300, 386, 'noisehill3');
            spec.anchor.setTo(.5,1);
            spec.alpha = .4;
            spec.scale.setTo(40);
            spec.design = 2;
             spec = this.specialgroup.create(300, 514, 'noisehill3');
            spec.anchor.setTo(.5,1);
            spec.alpha = .4;
            spec.scale.setTo(40,-40);
            spec.design = 3;
			
			 spec = this.specialgroup.create(245, 240, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(335, 240, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(425, 240, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(515, 240, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(605, 240, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(695, 240, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(785, 240, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(875, 240, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
             spec = this.specialgroup.create(965, 240, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
             spec = this.specialgroup.create(1055, 240, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 ...
			 spec = this.specialgroup.create(245, 660, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(335, 660, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(425, 660, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(515, 660, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(605, 660, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(695, 660, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
			 spec = this.specialgroup.create(875, 660, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
             spec = this.specialgroup.create(965, 660, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
			spec.tint = 0xFF0000;
             spec = this.specialgroup.create(1055, 660, 'pit');
            spec.anchor.setTo(.5);
            spec.alpha = .3;
            spec.scale.setTo(4);
            spec.design = 5;
...
electronSpawn: function(){
    switch(this.screen){
        case 0: {
            ...
            glow= this.electrongroup.create(950, 630, 'electron');
            break;
        }
        case 1: {
            glow= this.electrongroup.create(650, 330, 'electron');
            glow= this.electrongroup.create(650, 600, 'electron');
            glow= this.electrongroup.create(470, 283, 'electron');
			glow= this.electrongroup.create(760, 500, 'electron');
            break;
        }
        case 2: {
            glow= this.electrongroup.create(800, 600, 'electron');
            glow= this.electrongroup.create(800, 300, 'electron');
            glow= this.electrongroup.create(1070, 450, 'electron');
            break;
        }
        case 3: {
            glow= this.electrongroup.create(610, 600, 'electron');
            glow= this.electrongroup.create(694, 636, 'electron');
            glow= this.electrongroup.create(485, 385, 'electron');
            glow= this.electrongroup.create(417, 417, 'electron');
			glow= this.electrongroup.create(415, 530, 'electron');
			glow= this.electrongroup.create(765, 405, 'electron');
			glow= this.electrongroup.create(750, 350, 'electron');
			glow= this.electrongroup.create(600, 370, 'electron');
            break;
        }
        case 4: {
            glow= this.electrongroup.create(500, 400, 'electron');
            glow= this.electrongroup.create(650, 290, 'electron');
            glow= this.electrongroup.create(830, 392, 'electron');
            glow= this.electrongroup.create(830, 520, 'electron');
            glow= this.electrongroup.create(1030, 480, 'electron');
			glow= this.electrongroup.create(625, 545, 'electron');
			glow= this.electrongroup.create(500, 662, 'electron');
            break;
        }
        case 5: {
            glow= this.electrongroup.create(1060, 650, 'electron');
            glow= this.electrongroup.create(960, 450, 'electron');
            glow= this.electrongroup.create(325, 568, 'electron');
            glow= this.electrongroup.create(1023, 318, 'electron');
            glow= this.electrongroup.create(260, 380, 'electron');
            break;
        }
        case 6: {
            glow= this.electrongroup.create(483, 362, 'electron');
            glow= this.electrongroup.create(377, 452, 'electron');
            glow= this.electrongroup.create(880, 375, 'electron');
            glow= this.electrongroup.create(880, 500, 'electron');
			glow= this.electrongroup.create(243, 243, 'electron');
			glow= this.electrongroup.create(1057, 243, 'electron');
			glow= this.electrongroup.create(1057, 657, 'electron');
			glow= this.electrongroup.create(243, 657, 'electron');
            break;
        }
        case 7: {
            glow= this.electrongroup.create(660, 240, 'electron');
            glow= this.electrongroup.create(940, 300, 'electron');
            glow= this.electrongroup.create(700, 355, 'electron');
			glow= this.electrongroup.create(215, 622, 'electron');
			glow= this.electrongroup.create(610, 633, 'electron');
            break;
        }
        case 8: {
            glow= this.electrongroup.create(600, 530, 'electron');
            glow= this.electrongroup.create(700, 530, 'electron');
            glow= this.electrongroup.create(760, 430, 'electron');
            glow= this.electrongroup.create(540, 430, 'electron');
            glow= this.electrongroup.create(425, 530, 'electron');
            glow= this.electrongroup.create(875, 530, 'electron');
            break;
        }
    }
...
objectSpawn: function(){
    switch(this.screen){
        case 0: {
             bump = this.objectgroup.create(350, 350, 'bumpcolumn');
            bump.tint = 0xFF6666;;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
             bump = this.objectgroup.create(350, 550, 'bumpcolumn');
            bump.tint = 0xFF6666;;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(950, 350, 'bumpcolumn');
            bump.tint = 0xFF6666;;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(950, 550, 'bumpcolumn');
            bump.tint = 0xFF6666;;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
        ...
        case 1: {
            ...
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(790, 365, 'bumpcolumn');
            bump.tint = 0xFF6666;;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(300, 525, 'bumpcolumn');
            bump.tint = 0xFF6666;;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(990, 510, 'bumpcolumn');
            bump.tint = 0xFF6666;;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
        ...
        case 2: {
             bump = this.objectgroup.create(995, 450, 'bumpcolumn');
            bump.tint = 0xFF6666;;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
             bump = this.objectgroup.create(305, 450, 'bumpcolumn');
            bump.tint = 0xFF6666;;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(675, 450, 'bumpcolumn');
            bump.tint = 0xFF6666;;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
			 ...
			 bump = this.objectgroup.create(675, 220, 'bumptri3');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
            ...
            bump.body.static = true;
            bump.body.angle = 90;
			 bump = this.objectgroup.create(675, 680, 'bumptri3');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "triangle3");
        ...
        case 3: {
            ...
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(500, 620, 'bumprect1');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.alpha = 0;
        ...
        case 4: {
             bump = this.objectgroup.create(750, 210, 'bumpcolumn');
            bump.tint = 0xFF6666;;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
             bump = this.objectgroup.create(750, 690, 'bumpcolumn');
            bump.tint = 0xFF6666;;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(420, 470, 'bumpcolumn');
            bump.tint = 0xFF6666;;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(925, 240, 'bumpcolumn');
            bump.tint = 0xFF6666;;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(540, 288, 'bumpcolumn');
            bump.tint = 0xFF6666;;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
        ...
        case 5: {
             bump = this.objectgroup.create(478, 450, 'bumprect1');
            bump.tint = 0xFF6666;
            bump.anchor.setTo(.5);
            bump.alpha = 0;
            ...
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(822, 450, 'bumprect1');
            bump.tint = 0xFF6666;
            bump.anchor.setTo(.5);
            bump.alpha = 0;
        ...
        case 6: {
             bump = this.objectgroup.create(853, 300, 'bumprect1');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(853, 600, 'bumprect1');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(952, 375, 'bumprect1');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
			bump.body.clearShapes();
            bump.body.setRectangle(310, 25, 75, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
			bump.body.angle = 90;
			 bump = this.objectgroup.create(952, 525, 'bumprect1');
            bump.tint = 0xFF6666;
            bump.anchor.setTo(.5);
            bump.alpha = 0;
			bump.angle = 90;
			
			 bump = this.objectgroup.create(447, 300, 'bumprect1');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(447, 600, 'bumprect1');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(348, 375, 'bumprect1');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
			bump.body.clearShapes();
            bump.body.setRectangle(310, 25, 75, 0, 0);
            ...
            bump.alpha = 0;
			bump.body.angle = 90;
			 bump = this.objectgroup.create(348, 525, 'bumprect1');
            bump.tint = 0xFF6666;
            bump.anchor.setTo(.5);
            bump.alpha = 0;
			bump.angle = 90;
        ...
        case 7: {
             bump = this.objectgroup.create(286, 300, 'bumprect1');
            bump.tint = 0xFF6666;
            bump.anchor.setTo(.5)
            bump.alpha = 0;
			 bump = this.objectgroup.create(458, 300, 'bumprect1');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
			bump.body.clearShapes();
            bump.body.setRectangle(680, 25, 86, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(630, 300, 'bumprect1');
            bump.tint = 0xFF6666;
            bump.anchor.setTo(.5);
            bump.alpha = 0;
			 bump = this.objectgroup.create(802, 300, 'bumprect1');
            bump.tint = 0xFF6666;
            bump.anchor.setTo(.5);
            bump.alpha = 0;
			
			 bump = this.objectgroup.create(972, 254, 'bumprect1');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.alpha = 0;
			bump.body.angle = 50;
			 bump = this.objectgroup.create(972, 369, 'bumprect1');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.alpha = 0;
			bump.body.angle = -50;
			 ...
			 bump = this.objectgroup.create(855, 423, 'bumprect1');
            bump.tint = 0xFF6666;
            bump.anchor.setTo(.5);
            bump.alpha = 0;
			 bump = this.objectgroup.create(683, 423, 'bumprect1');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
			bump.body.clearShapes();
            bump.body.setRectangle(506, 25, 0, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(511, 423, 'bumprect1');
            bump.tint = 0xFF6666;
            bump.anchor.setTo(.5);
            bump.alpha = 0;
			
			 bump = this.objectgroup.create(351, 328, 'bumptri3');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "triangle3");
            ...
            bump.body.angle = -135;
			 ...
			 bump = this.objectgroup.create(320, 383, 'bumprect1');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
			bump.body.clearShapes();
            bump.body.setRectangle(287, 25, 70, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
			bump.body.angle = 90;
			 bump = this.objectgroup.create(320, 510, 'bumprect1');
            bump.tint = 0xFF6666;
            bump.anchor.setTo(.5);
            bump.alpha = 0;
			bump.angle = 90;
			 bump = this.objectgroup.create(440, 499, 'bumprect1');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.alpha = 0;
			bump.body.angle = 90;
			 ...
			 bump = this.objectgroup.create(223, 589, 'bumprect1');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(516, 589, 'bumprect1');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(712, 589, 'bumprect1');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(614, 614, 'bumprect1');
            bump.tint = 0xFF6666;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.alpha = 0;
        ...
        case 8: {
             bump = this.objectgroup.create(650, 530, 'bumpcolumn');
            bump.tint = 0xFF6666;;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
            bump.alpha = 0;
			 bump = this.objectgroup.create(400, 400, 'bumpcolumn');
            bump.tint = 0xFF6666;;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.setCircle(24, 0, 0, 0);
