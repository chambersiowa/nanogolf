...
Nanogolf.Circuitb = function(){};

Nanogolf.Circuitb.prototype = {
preload: function() {
    this.screen = 0;
    this.goal = 3;
    this.sgoal = 3;
...
create: function() {
    ...
    this.sparkglow4.alpha = .2;
     ...
     this.pad = this.add.sprite(250, 390, 'pad');
	this.pad.anchor.setTo(.5);
    this.pad.alpha = 0;
	 this.hole = this.add.sprite(250, 390, 'hole');
    ...
    this.ball.spawnx = 880;
    this.ball.spawny = 600;
    ...
    //this.testtext = this.add.text(300, 300, 'test', { font: "30px Fixedsys", fill: "#ffffff", align: "center" });
...
bumpUpdate: function(){
    ...
    switch(this.screen){
	    ...
	    if(this.ball.inactive){return;}
            if(this.ball.y + 3 < this.objectgroup.children[0].y){this.objectgroup.children[0].body.y -= 2.5;}
            else if(this.ball.y - 3 > this.objectgroup.children[0].y){this.objectgroup.children[0].body.y += 2.5;}
            break;}
        case 3: {break;}
        case 4: {break;}
        case 5: {
		if(this.ball.y > 620){return;}
		if(this.ball.y > 539){if(this.ball.y < 585){if(this.ball.x > 370){if(this.ball.x < 517){return;}}}}
		if(this.ball.y > 299){if(this.ball.y < 344){if(this.ball.x > 315){if(this.ball.x < 452){return;}}}}
		if(this.ball.y > 383){if(this.ball.y < 425){if(this.ball.x > 851){if(this.ball.x < 995){return;}}}}
		this.ball.body.y += 1.3;
		break;}
        case 6: {break;}
        case 7: {
            for(var i=0; i<this.objectgroup.length; i++){
                if(i < 4){
                    this.objectgroup.children[i].body.y += 2;
                    if(this.objectgroup.children[i].body.y > 749){this.objectgroup.children[i].body.y = 150;}
                }
                else{
                    this.objectgroup.children[i].body.y -= 2;
                    if(this.objectgroup.children[i].body.y < 151){this.objectgroup.children[i].body.y = 750;}
                }
            }
            break;}
        case 8: {
            ...
            if(this.coursetimer){
                if(this.ball.x < 400){
                    this.objectgroup.children[2].body.y = 100;
                    this.objectgroup.children[3].body.y = 100;
                    this.coursetimer = 0;
                }
            }
            else{
                if(this.ball.x > 745){
                    this.objectgroup.children[2].body.y = 651;
                    this.objectgroup.children[3].body.y = 249;
                    this.coursetimer = 1;
                }
            }
            break;}
...
slowChange: function(){
		...
		if(this.screen == 6){
			this.objectgroup.children[0].body.rotateLeft(4);
			this.objectgroup.children[1].body.rotateLeft(4); //jump2
			for(i=2; i<14; i++){
				this.objectgroup.children[i].body.rotateRight(4);
			}
			for(i=14; i<20; i++){
				this.objectgroup.children[i].body.rotateLeft(4);
			}
		}
},
...
fireShot: function(){
	...
	if(this.aimactive){
        if(this.slowmode){
			...
			if(this.screen == 6){
				this.objectgroup.children[0].body.rotateLeft(18);
				this.objectgroup.children[1].body.rotateLeft(18); //jump2
				for(i=2; i<14; i++){
					this.objectgroup.children[i].body.rotateRight(18);
				}
				for(i=14; i<20; i++){
					this.objectgroup.children[i].body.rotateLeft(18);
				}
			}
			this.slowmode = false;
		}
...
despawnUpdate: function(){
    ...
    if(this.objectgroup.children[0].alpha == 0){
        ...
        switch(this.screen){ //jumphere
            case 0: {this.ball.spawnx = 880; this.ball.spawny = 600; this.goal = 3; this.sgoal = 3;
                     this.hole.x = 250; this.hole.y = 390; this.pad.x = 250; this.pad.y = 390; break;}
            case 1: {this.ball.spawnx = 1020; this.ball.spawny = 620; this.goal = 4; this.sgoal = 4;
                     this.hole.x = 260; this.hole.y = 340; this.pad.x = 260; this.pad.y = 340; break;}
            case 2: {this.ball.spawnx = 340; this.ball.spawny = 450; this.goal = 3; this.sgoal = 3;
                     this.hole.x = 250; this.hole.y = 450; this.pad.x = 250; this.pad.y = 450; break;}
            case 3: {this.ball.spawnx = 250; this.ball.spawny = 475; this.goal = 6; this.sgoal = 6;
                     this.hole.x = 975; this.hole.y = 635; this.pad.x = 975; this.pad.y = 635; break;}
            case 4: {this.ball.spawnx = 1000; this.ball.spawny = 350; this.goal = 4; this.sgoal = 4;
                     this.hole.x = 240; this.hole.y = 285; this.pad.x = 240; this.pad.y = 285; break;}
            case 5: {this.ball.spawnx = 430; this.ball.spawny = 537; this.goal = 4; this.sgoal = 4;
                     this.hole.x = 450; this.hole.y = 650; this.pad.x = 450; this.pad.y = 650; break;}
            case 6: {this.ball.spawnx = 250; this.ball.spawny = 250; this.goal = 4; this.sgoal = 4;
                     this.hole.x = 400; this.hole.y = 575; this.pad.x = 400; this.pad.y = 575; break;}
            case 7: {this.ball.spawnx = 250; this.ball.spawny = 300; this.goal = 3; this.sgoal = 3;
                     this.hole.x = 300; this.hole.y = 550; this.pad.x = 300; this.pad.y = 550; break;} 
            case 8: {this.ball.spawnx = 250; this.ball.spawny = 450; this.goal = 7; this.sgoal = 7;
                     this.hole.x = 420; this.hole.y = 450; this.pad.x = 420; this.pad.y = 450; break;}
        }
...
specialSpawn: function(){
    switch(this.screen){
        case 0: {break;}
        case 1: {
			this.spawnVeyerBelt(350, 350, 0);
			this.spawnVeyerBelt(430, 350, 0);
            this.spawnVeyerBelt(510, 350, 0);
			this.spawnVeyerBelt(590, 350, 0);
            break;}
        case 2: {break;}
        case 3: {break;}
        case 4: {
			this.spawnVeyerBelt(928, 535, -180);
            this.spawnVeyerBelt(848, 535, -180);
			this.spawnVeyerBelt(768, 535, -180);
            this.spawnVeyerBelt(688, 535, -180);
            this.spawnVeyerBelt(608, 535, -180);
            this.spawnVeyerBelt(538, 515, -90);
            this.spawnVeyerBelt(538, 435, -90);
            this.spawnVeyerBelt(550, 368, -180);
			this.spawnVeyerBelt(470, 368, -180);
            this.spawnVeyerBelt(405, 365, 90);
			this.spawnVeyerBelt(307, 435, -180);
            this.spawnVeyerBelt(388, 435, -180);
			this.spawnVeyerBelt(236, 425, -90);
            this.spawnVeyerBelt(236, 345, -90);
            break;}
        case 5: {
			this.spawnVeyerHalf(230, 246);
			this.spawnVeyerHalf(290, 246);
			this.spawnVeyerHalf(350, 246);
			this.spawnVeyerHalf(410, 246);
			this.spawnVeyerHalf(470, 246);
			this.spawnVeyerHalf(530, 246);
			this.spawnVeyerHalf(590, 246);
			this.spawnVeyerHalf(650, 246);
			this.spawnVeyerHalf(710, 246);
			this.spawnVeyerHalf(770, 246);
			this.spawnVeyerHalf(830, 246);
			this.spawnVeyerHalf(890, 246);
			this.spawnVeyerHalf(950, 246);
			this.spawnVeyerHalf(1010, 246);
			this.spawnVeyerHalf(1070, 246);
			
			this.spawnVeyerHalf(230, 326);
			this.spawnVeyerHalf(530, 326);
			this.spawnVeyerHalf(590, 326);
			this.spawnVeyerHalf(650, 326);
			this.spawnVeyerHalf(710, 326);
			this.spawnVeyerHalf(770, 326);
			this.spawnVeyerHalf(830, 326);
			this.spawnVeyerHalf(890, 326);
			this.spawnVeyerHalf(950, 326);
			this.spawnVeyerHalf(1010, 326);
			this.spawnVeyerHalf(1070, 326);
			
			this.spawnVeyerHalf(230, 406);
			this.spawnVeyerHalf(290, 406);
			this.spawnVeyerHalf(350, 406);
			this.spawnVeyerHalf(410, 406);
			this.spawnVeyerHalf(470, 406);
			this.spawnVeyerHalf(530, 406);
			this.spawnVeyerHalf(590, 406);
			this.spawnVeyerHalf(650, 406);
			this.spawnVeyerHalf(710, 406);
			this.spawnVeyerHalf(770, 406);
			this.spawnVeyerHalf(1070, 406);
			this.spawnVeyerHalf(230, 486);
			this.spawnVeyerHalf(290, 486);
			this.spawnVeyerHalf(350, 486);
			this.spawnVeyerHalf(410, 486);
			this.spawnVeyerHalf(470, 486);
			this.spawnVeyerHalf(530, 486);
			this.spawnVeyerHalf(590, 486);
			this.spawnVeyerHalf(650, 486);
			this.spawnVeyerHalf(710, 486);
			this.spawnVeyerHalf(770, 486);
			this.spawnVeyerHalf(830, 486);
			this.spawnVeyerHalf(890, 486);
			this.spawnVeyerHalf(950, 486);
			this.spawnVeyerHalf(1010, 486);
			this.spawnVeyerHalf(1070, 486);
			this.spawnVeyerHalf(230, 566);
			this.spawnVeyerHalf(290, 566);
			this.spawnVeyerHalf(590, 566);
			this.spawnVeyerHalf(650, 566);
			this.spawnVeyerHalf(710, 566);
			this.spawnVeyerHalf(770, 566);
			this.spawnVeyerHalf(830, 566);
			this.spawnVeyerHalf(890, 566);
			this.spawnVeyerHalf(950, 566);
			this.spawnVeyerHalf(1010, 566);
			this.spawnVeyerHalf(1070, 566);
			break;}
        case 6: {break;}
        case 7: {break;}
        case 8: {
			this.spawnVeyerBelt(470, 450, -180);
			this.spawnVeyerBelt(550, 450, -180);
			this.spawnVeyerBelt(630, 450, -180);
            this.spawnVeyerBelt(710, 450, -180);
            this.spawnVeyerBelt(790, 450, -180);
            this.spawnVeyerBelt(870, 450, -180);
			this.spawnVeyerBelt(950, 450, -180);
            this.spawnVeyerBelt(1030, 450, -180);
			
            this.spawnVeyerBelt(520, 388, -180);
            this.spawnVeyerBelt(600, 388, -180);
            this.spawnVeyerBelt(680, 388, -180);
            this.spawnVeyerBelt(760, 388, -180);
            this.spawnVeyerBelt(840, 388, -180);
            this.spawnVeyerBelt(920, 388, -180);
            this.spawnVeyerBelt(1000, 388, -180);
			
            this.spawnVeyerBelt(520, 512, -180);
            this.spawnVeyerBelt(600, 512, -180);
            this.spawnVeyerBelt(680, 512, -180);
			this.spawnVeyerBelt(760, 512, -180);
			this.spawnVeyerBelt(840, 512, -180);
			this.spawnVeyerBelt(920, 512, -180);
            this.spawnVeyerBelt(1000, 512, -180);
            
            this.spawnVeyerBelt(600, 326, -180);
            this.spawnVeyerBelt(680, 326, -180);
            this.spawnVeyerBelt(760, 326, -180);
			this.spawnVeyerBelt(840, 326, -180);
            this.spawnVeyerBelt(920, 326, -180);
			this.spawnVeyerBelt(1000, 326, -180);
            
			this.spawnVeyerBelt(600, 574, -180);
			this.spawnVeyerBelt(680, 574, -180);
			this.spawnVeyerBelt(760, 574, -180);
            this.spawnVeyerBelt(840, 574, -180);
			this.spawnVeyerBelt(920, 574, -180);
			this.spawnVeyerBelt(1000, 574, -180);
			
			this.spawnVeyerBelt(640, 636, -180);
            this.spawnVeyerBelt(720, 636, -180);
			this.spawnVeyerBelt(800, 636, -180);
			this.spawnVeyerBelt(880, 636, -180);
			this.spawnVeyerBelt(960, 636, -180);
			this.spawnVeyerBelt(1040, 636, -180);

			this.spawnVeyerBelt(640, 264, -180);
            this.spawnVeyerBelt(720, 264, -180);
			this.spawnVeyerBelt(800, 264, -180);
            this.spawnVeyerBelt(880, 264, -180);
			this.spawnVeyerBelt(960, 264, -180);
            this.spawnVeyerBelt(1040, 264, -180);
            break;}
    }
},
...
electronSpawn: function(){
    switch(this.screen){
        case 0: {
            glow= this.electrongroup.create(380, 520, 'electron');
            glow= this.electrongroup.create(545, 370, 'electron');
            glow= this.electrongroup.create(690, 520, 'electron');
            break;
        }
        case 1: {
            glow= this.electrongroup.create(825, 560, 'electron');
            glow= this.electrongroup.create(825, 400, 'electron');
            glow= this.electrongroup.create(825, 290, 'electron');
            glow= this.electrongroup.create(750, 345, 'electron');
            break;
        }
        case 2: {
            glow= this.electrongroup.create(920, 450, 'electron');
			glow= this.electrongroup.create(565, 580, 'electron');
            glow= this.electrongroup.create(565, 320, 'electron');
            break;
        }
        case 3: {
            glow= this.electrongroup.create(500, 500, 'electron');
            glow= this.electrongroup.create(900, 300, 'electron');
            glow= this.electrongroup.create(600, 400, 'electron');
            glow= this.electrongroup.create(700, 300, 'electron');
            glow= this.electrongroup.create(400, 400, 'electron');
            glow= this.electrongroup.create(800, 400, 'electron');
            break;
        }
        case 4: {
            glow= this.electrongroup.create(715, 320, 'electron');
            glow= this.electrongroup.create(410, 635, 'electron');
            glow= this.electrongroup.create(1025, 435, 'electron');
            glow= this.electrongroup.create(236, 330, 'electron');
            break;
        }
        case 5: {
            glow= this.electrongroup.create(360, 310, 'electron');
            glow= this.electrongroup.create(410, 310, 'electron');
            glow= this.electrongroup.create(900, 390, 'electron');
            glow= this.electrongroup.create(950, 390, 'electron');
            break;
        }
        case 6: {
            glow= this.electrongroup.create(525, 325, 'electron');
            glow= this.electrongroup.create(775, 325, 'electron');
            glow= this.electrongroup.create(525, 575, 'electron');
            glow= this.electrongroup.create(775, 575, 'electron');
            break;
        }
        case 7: {
        ...
        case 8: {
			...
			glow= this.electrongroup.create(600, 420, 'electron');
            glow= this.electrongroup.create(650, 510, 'electron');
            glow= this.electrongroup.create(700, 340, 'electron');
            glow= this.electrongroup.create(750, 460, 'electron');
            glow= this.electrongroup.create(800, 550, 'electron');
            glow= this.electrongroup.create(850, 340, 'electron');
            break;
        }
    }
...
objectSpawn: function(){
    switch(this.screen){
        case 0: {
             bump = this.objectgroup.create(460, 375, 'bumptri3');
            bump.tint = 0x6666FF;
            ...
            bump.body.angle = -90;
             bump = this.objectgroup.create(460, 525, 'bumptri3');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "triangle3");
            bump.body.static = true;
            bump.body.angle = 90;
             bump = this.objectgroup.create(460, 450, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
            bump.body.static = true;
             bump = this.objectgroup.create(600, 450, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = 90;
             bump = this.objectgroup.create(320, 450, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = 90;
        ...
        case 1: {
             bump = this.objectgroup.create(750, 654, 'bumprect1'); 
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
		bump.body.clearShapes();
            ...
            bump.body.static = true;
            bump.body.angle = 90;
             bump = this.objectgroup.create(750, 482, 'bumprect1');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
            bump.angle = 90;
             bump = this.objectgroup.create(750, 220, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = 90;
             bump = this.objectgroup.create(900, 462, 'bumprect1'); //890 570 - 210 370 - 995 385
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
		bump.body.clearShapes();
            bump.body.setRectangle(370, 210, -77, -96, 0);
            bump.body.static = true;
            bump.body.angle = 90;
             bump = this.objectgroup.create(900, 290, 'bumprect1');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
            bump.angle = 90;
             bump = this.objectgroup.create(974, 560, 'bumprect1');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
             bump = this.objectgroup.create(1146, 560, 'bumprect1');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
             bump = this.objectgroup.create(565, 305, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            ...
            bump.body.rotateLeft(18);
             bump = this.objectgroup.create(365, 305, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "column1");
            bump.body.static = true;
            bump.body.rotateLeft(18);
             bump = this.objectgroup.create(465, 395, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "column1");
            ...
            bump.body.rotateRight(18);
             bump = this.objectgroup.create(410, 490, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = 55;
             bump = this.objectgroup.create(651, 290, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
             bump = this.objectgroup.create(479, 290, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
             bump = this.objectgroup.create(307, 290, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
             bump = this.objectgroup.create(210, 362, 'bumprect1');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
            bump.angle = 90;
             bump = this.objectgroup.create(210, 534, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
		bump.body.clearShapes();
            bump.body.setRectangle(516, 25, 0, 0, 0);
            bump.body.static = true;
            bump.body.angle = 90;
             bump = this.objectgroup.create(210, 706, 'bumprect1');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
            bump.angle = 90;
             bump = this.objectgroup.create(394, 410, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
             bump = this.objectgroup.create(536, 410, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
		bump.body.clearShapes();
            bump.body.setRectangle(197, 170, 12, 73, 0);
            bump.body.static = true;
             bump = this.objectgroup.create(635, 484, 'bumprect1');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
            bump.angle = 90;
             bump = this.objectgroup.create(537, 555, 'bumprect1');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
             bump = this.objectgroup.create(651, 690, 'bumprect1');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
             bump = this.objectgroup.create(479, 690, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
		bump.body.clearShapes();
            bump.body.setRectangle(516, 25, 0, 0, 0);
            bump.body.static = true;
             bump = this.objectgroup.create(307, 690, 'bumprect1');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
            break;
        }
        case 2: {
             bump = this.objectgroup.create(750, 450, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = 90;
	         bump = this.objectgroup.create(750, 225, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
            bump.body.static = true;
	         bump = this.objectgroup.create(750, 675, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
        ...
        case 3: {
	     bump = this.objectgroup.create(400, 300, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
	     bump = this.objectgroup.create(400, 500, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
	     bump = this.objectgroup.create(400, 700, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
 	     bump = this.objectgroup.create(500, 200, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
	     bump = this.objectgroup.create(500, 400, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
	     bump = this.objectgroup.create(500, 600, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
	     bump = this.objectgroup.create(600, 300, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
	     bump = this.objectgroup.create(600, 500, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
	     bump = this.objectgroup.create(600, 700, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
 	     bump = this.objectgroup.create(700, 200, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
	     bump = this.objectgroup.create(700, 400, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
	     bump = this.objectgroup.create(700, 600, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
	     bump = this.objectgroup.create(800, 300, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
	     bump = this.objectgroup.create(800, 500, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
	     bump = this.objectgroup.create(800, 700, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
 	     bump = this.objectgroup.create(900, 200, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
	     bump = this.objectgroup.create(900, 400, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
	     bump = this.objectgroup.create(900, 600, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
        ...
        case 4: {
             bump = this.objectgroup.create(900, 350, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.setRectangle(196, 196, -50, 50, 0);
            bump.body.static = true;
             bump = this.objectgroup.create(900, 450, 'bumpsquare');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
             bump = this.objectgroup.create(800, 450, 'bumpsquare');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
             bump = this.objectgroup.create(800, 350, 'bumpsquare');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
             bump = this.objectgroup.create(900, 625, 'bumpsquare');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
             bump = this.objectgroup.create(800, 625, 'bumpsquare');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
             bump = this.objectgroup.create(700, 625, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.setRectangle(496, 98, 0, 0, 0);
            bump.body.static = true;
             bump = this.objectgroup.create(600, 625, 'bumpsquare');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
             bump = this.objectgroup.create(500, 625, 'bumpsquare');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
             bump = this.objectgroup.create(1150, 687.5, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
             bump = this.objectgroup.create(978, 687.5, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
             bump = this.objectgroup.create(806, 687.5, 'bumprect1');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
             bump = this.objectgroup.create(634, 687.5, 'bumprect1');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
             bump = this.objectgroup.create(462, 687.5, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
             bump = this.objectgroup.create(580, 312, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
             bump = this.objectgroup.create(630, 450, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.setRectangle(96, 196, 0, -50, 0);
            bump.body.static = true;
             bump = this.objectgroup.create(630, 350, 'bumpsquare');
            bump.tint = 0x6666FF;
            bump.anchor.setTo(.5);
             bump = this.objectgroup.create(487, 490, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = 90;
             bump = this.objectgroup.create(462, 490, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = 90; 
             bump = this.objectgroup.create(408, 312, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
             bump = this.objectgroup.create(363, 561, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = 90;
             bump = this.objectgroup.create(363, 733, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = 90;
             bump = this.objectgroup.create(265, 487, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
             bump = this.objectgroup.create(320, 350, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
        ...
        case 5: {
             bump = this.objectgroup.create(386, 345, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
		 bump = this.objectgroup.create(315, 332, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
		 bump = this.objectgroup.create(457, 332, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
             bump = this.objectgroup.create(926, 425, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
		 bump = this.objectgroup.create(855, 412, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
		 bump = this.objectgroup.create(997, 412, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
             bump = this.objectgroup.create(446, 585, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
		 bump = this.objectgroup.create(375, 572, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
		 bump = this.objectgroup.create(517, 572, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.setCircle(24, 0, 0, 0);
            bump.body.static = true;
        ...
        case 6: {
            ...
            bump.body.static = true;
            bump.body.rotateLeft(14);
             bump = this.objectgroup.create(400, 200, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
            bump.body.static = true;
            bump.body.rotateRight(14);
             bump = this.objectgroup.create(500, 200, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
            bump.body.static = true;
            bump.body.rotateRight(14);
             bump = this.objectgroup.create(600, 200, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
            bump.body.static = true;
            bump.body.rotateRight(14);
             bump = this.objectgroup.create(700, 200, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
            bump.body.static = true;
            bump.body.rotateRight(14);
             bump = this.objectgroup.create(800, 200, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
            bump.body.static = true;
            bump.body.rotateRight(14);
             bump = this.objectgroup.create(900, 200, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
            bump.body.static = true;
            bump.body.rotateRight(14);
			 bump = this.objectgroup.create(400, 700, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
            bump.body.static = true;
            bump.body.rotateRight(14);
             bump = this.objectgroup.create(500, 700, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
            bump.body.static = true;
            bump.body.rotateRight(14);
             bump = this.objectgroup.create(600, 700, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
            bump.body.static = true;
            bump.body.rotateRight(14);
             bump = this.objectgroup.create(700, 700, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
            bump.body.static = true;
            bump.body.rotateRight(14);
             bump = this.objectgroup.create(800, 700, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
            bump.body.static = true;
            bump.body.rotateRight(14);
             bump = this.objectgroup.create(900, 700, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
            bump.body.static = true;
            bump.body.rotateRight(14);
             bump = this.objectgroup.create(400, 450, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
            bump.body.static = true;
            bump.body.rotateLeft(14);
             bump = this.objectgroup.create(500, 450, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
            bump.body.static = true;
            bump.body.rotateLeft(14);
             bump = this.objectgroup.create(600, 450, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
            bump.body.static = true;
            bump.body.rotateLeft(14);
             bump = this.objectgroup.create(700, 450, 'bumpsquare');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "square1");
        ...
        case 7: {
             bump = this.objectgroup.create(525, 250, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = 1;
             bump = this.objectgroup.create(525, 400, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = 1;
             bump = this.objectgroup.create(525, 550, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = 1;
             bump = this.objectgroup.create(525, 700, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = 1;
             bump = this.objectgroup.create(775, 200, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = -1;
             bump = this.objectgroup.create(775, 350, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = -1;
             bump = this.objectgroup.create(775, 500, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = -1;
             bump = this.objectgroup.create(775, 650, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = -1;
        ...
        case 8: {
             bump = this.objectgroup.create(500, 360, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = -40;
             bump = this.objectgroup.create(500, 540, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = 40;
             bump = this.objectgroup.create(632, 100, 'bumprect1');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.static = true;
            bump.body.angle = 40;
            ...
            bump.body.static = true;
            bump.body.angle = -40;
             bump = this.objectgroup.create(360, 450, 'bumpcolumn');
            bump.tint = 0x6666FF;
            this.game.physics.p2.enable(bump);
            bump.body.clearShapes();
            bump.body.loadPolygon("sprite_physics", "column1");
